...
public class OrderLinkAdder {
    public void addLinks(Set<Order> orders) throws OrderNotFoundException, UpdateOrderFailedException {
        for (Order order : orders) {
            addLinks(order);
        }
    }

    public void addLinks(Order order) throws OrderNotFoundException, UpdateOrderFailedException {
